    ...
    return (
        <motion.form animate={{ opacity: [0, 1] }} transition={{ duration: .7 }} onSubmit={(e) => {
            ...
            <div className="form-group">
                ...
                <input type="text" name="name" id="su" className='inputBox' required autoComplete='off' placeholder='Enter full name...' onChange={e => setSignUpName(e.target.value)} />
            </div>
            <div className="form-group">
                <label htmlFor="email">Email @</label>
                <input type="email" name="email" id="su1" className='inputBox' required autoComplete='off' placeholder='Enter a valid email...' onChange={e => setSignUpEmail(e.target.value)} />
            </div>
            <div className="form-group">
                <label htmlFor="password">Password &#8226;&#8226;&#8226; </label>
                <input type="password" name="" id="" className='inputBox' autoComplete='off' placeholder='******' required onChange={e => setSignUpPassword(e.target.value)} />
            </div>
            <div className="form-group">
